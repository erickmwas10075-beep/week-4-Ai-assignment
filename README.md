...
Name:Erick Peter
## question 1
data is raw material that  required to be proccesed to become useful information
* e.g image,audio and text
## question 2
structured data is an organized data e.g database and spreadsheets while unstructured data is unorganized data e.g images and audio
## question 3
